...
**Dataset Source** : https://datahub.io/collections/world-bank, Google Dataset Search, Data.Gov, https://www.kaggle.com/datasets/theworldbank/education-statistics
...
## Context
This is a dataset hosted by the World Bank. The organization has an open data platform found here and they update their information according the amount of data that is brought in. Explore the World Bank using various sources available through the World Bank organization page!

**Following Countries have been selected for Analysis:-**
* India-> IND
* United States-> USA
* United Kingdom-> GBR
* Australia-> AUS
